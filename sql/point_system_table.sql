...
(
    id         bigint auto_increment comment 'id' primary key,
    rule_key   varchar(64)                        not null comment '规则键:SIGN_IN_BASE/SIGN_IN_CONTINUOUS_3/SIGN_IN_CONTINUOUS_7/SIGN_IN_CONTINUOUS_30/INVITE_NEW/INVITE_REWARD/DEPLOY_COST/GENERATE_COST/FIRST_GENERATE',
...
-- 消耗积分规则
INSERT INTO point_rule (rule_key, rule_value, rule_desc) VALUES 
('DEPLOY_COST', 20, '部署应用消耗积分'),
('GENERATE_COST', 10, '生成应用消耗积分');

-- 奖励积分规则
INSERT INTO point_rule (rule_key, rule_value, rule_desc) VALUES 
('FIRST_GENERATE', 50, '首次生成应用奖励积分');
